...
// Rota para upload de livro, jogo ou filme
router.post("/post", 
  upload.fields([
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    // Aqui removi a obrigatoriedade da capa:
      ...
      if (type === "book") {
        const book = await prisma.book.create({
          data: {
            ...
            // Só setar coverImagePath se existir capa
            ...(coverImage && { coverImagePath: coverImage.filename }),
          },
        });
